...
<script lang="ts">
  ...
  <div class="mb-4 flex flex-wrap gap-4 items-end">
    <div>
        ...
        <select id="party-select" bind:value={selectedParty} on:change={applyFilters} class="mt-1 p-2 border rounded">        
    ...
    <div>
        ...
        <select id="limit-select" bind:value={limit} on:change={applyFilters} class="mt-1 p-2 border rounded">        
